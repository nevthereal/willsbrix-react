    ...
    <div id="products" className="flex justify-center gap-4 flex-wrap my-4 2xl:max-w-[80%] mx-auto">
        ...
        <div className="border border-gray-300 bg-gray-200 rounded-2xl w-9/12 md:w-auto p-4 hover:scale-105 duration-200 mx-auto md:mx-0">
            <a href="/products/assassin-black">
                ...
                <p className="text-gray-700 font-bold">$5</p>
            </a>
        </div>
        <div className="border border-gray-300 bg-gray-200 rounded-2xl w-9/12 md:w-auto p-4 hover:scale-105 duration-200 mx-auto md:mx-0">
        ...
        <div className="border border-gray-300 bg-gray-200 rounded-2xl w-9/12 md:w-auto p-4 hover:scale-105 duration-200 mx-auto md:mx-0">
            <a href="/products/swamp-speeder">
                ...
                <p className="text-gray-700 font-bold">$35</p>
            </a>
        </div>
        <div className="border border-gray-300 bg-gray-200 rounded-2xl w-9/12 md:w-auto p-4 hover:scale-105 duration-200 mx-auto md:mx-0">
        ...
        <div className="border border-gray-300 bg-gray-200 rounded-2xl w-9/12 md:w-auto p-4 hover:scale-105 duration-200 mx-auto md:mx-0">
            <a href="/products/batmobile">
                <img className="p-2 w-96 mx-auto rounded-3xl" src={Batmobile} alt="bat mobile" />
                <p className="mb-4 font-bold text-2xl text-center">Batmobile</p>
                <p className="text-gray-700 font-bold">$20</p>
            </a>
        </div>
    </div>
