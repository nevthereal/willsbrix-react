...
const A_g = () => {
  return (
    <div>
        ...
        <img src={Ag} alt="gray assassin droid" class="w-80 md:w-[720px] my-4 mx-auto border border-gray-300 rounded-xl" />
        <div class="my-auto">
        <h1 class="font-bold text-2xl md:text-4xl m-4">Gray Assassin Droid</h1>
        ...
        <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=HC9LK2N8FJ5AY" class="border border-gray-400 py-1 px-2 rounded-lg hover:scale-105 duration-200"><p class="font-bold text-xl md:text-3xl my-auto">$5 <i class="fa-solid fa-cart-plus"></i></p></a>
        </div>
    ...
    <div id="gallery">
        ...
        <div class="flex flex-wrap justify-center gap-2 m-4"> 
            <img class="w-[480px] my-4 border border-gray-300 rounded-xl" src={Ag} alt="" />
            <img class="w-[480px] my-4 border border-gray-300 rounded-xl" src={Ag_back} alt="" />
            <img class="w-[480px] my-4 border border-gray-300 rounded-xl" src={Ag_or} alt="" />
        </div>
    </div>
    </div>
  )
